import { isValidIban, isPostiveNumber, isDateAfterToday, isEmailWellFormed, isStringValueInformed, isValueNotNullOrUndefined } from "./plain.validation";
...
describe("plain.validation", () => {
    ...
    describe("isPositiveNumber specs", () => {
        it("should return true when amount is positive", () => {
            ...
            //Act
            const result = isPostiveNumber(amount);

            //Assert
            expect(result).toBeTruthy();
        });

        it("should return false when amount is positive", () => {
